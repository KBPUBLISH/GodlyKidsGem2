...
const formatDateKeyUTC = (d) => d.toISOString().slice(0, 10);
...
router.get('/planner/day', async (req, res) => {
    try {
        ...
        // Gather already assigned lessons for this profile in this week window
        ...
        const ageQuery = { $or: [{ ageGroup: kidAgeGroup }, { ageGroup: 'all' }] };
        ...
        // Extreme fallback: allow repeats from week but keep unique within day.
