...
// Local, ad-free darts game bundled with the app — no external site.
const DARTS_GAME_URL = '/games/poptimez.html';
...
/**
 * In-app darts game (Poptimez) served from our own public assets, so kids
 * never leave the app and there are no third-party ads or splash screens.
 * Route: /sail/basement/darts — entered from the basement dartboard hotspot.
 */
const SailBoatBasementDartsPage: React.FC = () => {
      ...
      {loading && (
        <div className="absolute inset-0 flex items-center justify-center bg-[#16233A] z-10">
          <div className="text-center">
            ...
            <p className="text-white text-lg">Lining up the darts...</p>
          </div>
        </div>
      )}
...
export default SailBoatBasementDartsPage;
