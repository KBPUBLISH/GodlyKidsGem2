...
const BODY_PRESERVATION = " CRITICAL — body: Preserve the person's body type, build, and proportions exactly as in the reference photo. Do NOT make them heavier, rounder, or more muscular than in the photo. Do NOT exaggerate or cartoonify their body shape—keep the same slim, average, or heavy build as visible in the photo.";
